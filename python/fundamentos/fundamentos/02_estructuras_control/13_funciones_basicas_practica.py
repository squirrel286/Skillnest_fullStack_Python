...
# 
# Salida: 2450
#No imprime nada porque la funcion no esta definida
...
# x       | None
# Salida:24
# X no imprime nada porque el valor no es retornado
...
# Variables | Valores
#           |
# Salida: DiversonVerano
# Diversión aparece primero que el verano ya que esta concatenado de forma inversa
...
#           | 4
# Salida: 7
# El 2do return no se ejecuta porque el de arriba rompe la funcion devolviendo un valor
...
#
# Salida: 150, 350
# 12. Similar al anterior, pero la funcion retorna el valor local 'horas_de_juego'.
